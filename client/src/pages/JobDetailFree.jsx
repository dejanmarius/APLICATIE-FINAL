...
const JobDetailFree = () => {
  ...
  const alertandroute = () => {
    Swal.fire({
      ...
      text: "To access this feature, please log in or sign up to your account.",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        ...
        navigate("/user-auth", { state: { from: window.location.pathname } });
      }
    });
  };
